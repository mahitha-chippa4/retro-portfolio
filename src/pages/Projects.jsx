            ...
            <div className="max-w-[1000px] p-3 overflow-y-auto max-h-[600px] w-full text-black flex flex-col sm:flex-row relative px-5 pt-3 sm:gap-4">
                ...
                <div className="flex flex-col font-bold gap-2 relative">
                    ...
                    <button className="hover:bg-blue-400 text-sm sm:text-2xl flex justify-center items-center w-32 border-t-2 border-l-2 border-gray-200 border-b-2 border-r-2 border-b-gray-500 border-r-gray-500 bg-blue-600 text-white cursor-pointer shadow-md">
                        <a href={current.link} target="_blank" className="h-full w-full">Explore</a>
                    </button>
                    {/* sticker */}
                    ...
                    {projects.map((project, i) => (
                        <>
                            <button
                                ...
                                className={`hidden sm:block text-sm px-2  hover:bg-blue-600 hover:text-white font-bold transition-transform duration-300 ${activeTab === i ? "bg-blue-600 text-white" : " text-black"
                                    }`}
                            ...
                            <button
                                key={i}
                                onClick={() => setActiveTab(i)}
                                className={`sm:hidden block text-lg px-1  hover:bg-blue-600 hover:text-white font-bold transition-transform duration-300 ${activeTab === i ? "bg-blue-600 text-white" : " text-black"
                                    }`}
