...
- 🖱️ **[react-draggable](https://www.npmjs.com/package/react-draggable)** — draggable windows & icons  
...
- Retro OS–style desktop with clickable `.exe` applications  
- Draggable, windowed UI components  
- Pixel-art design inspired by classic operating systems  
- Custom bootloader animation featuring a pixel rabbit 🐰  
